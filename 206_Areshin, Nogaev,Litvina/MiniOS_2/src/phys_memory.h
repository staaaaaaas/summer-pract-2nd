// phys_memory.h -- Определяет интерфейс и структуры, используемы для работы с жестким диском
#ifndef PHYS_MEMORY
#define PHYS_MEMORY
...
typedef struct page_directory
{
    ...
    **/
    ...
    /**
      Массив указателей на таблицы страниц, о которых говорилось выше, 
      но указатели указывают *физическое* местоположение, используемое 
      при загрузке в регистр CR3.
    **/
...
/**
  ...
  Если make == 1 в таблице страниц, в которой 
  эта страница должна располагаться,то страница 
  не создана - создайте страницу!
**/
